...
//
//// Only update the state from buttons if we are NOT currently shooting
//            if (shooterState != ShooterState.SHOOTING) {
//                if (shootRaw) {
//                    shooterState = ShooterState.SPINUP_FIXED;
//                } else if (shootDynamic) {
//                    shooterState = ShooterState.SPINUP_DYNAMIC;
//                } else if (intakeIn) {
...
//                    if (!(hue > 145 && hue < 205)) { robot.intake.runTransfer(); }
//                    robot.latch.setPosition(Robot.LATCH_CLOSED);
//                    break;
//
//                case OUTTAKING:
...
//                    // Note: Target velocity is handled inside shooter.periodic(target)
//                    if (robot.shooter.isAtTargetVelocity()) {
//                        shooterState = ShooterState.SHOOTING;
//                    }
//                    break;
...
//
//                    // EXIT CONDITION: Return to IDLE when buttons are released
//                    if (!shootRaw && !shootDynamic) {
//                        shooterState = ShooterState.IDLE;
//                    }
//                    break;
//            }
